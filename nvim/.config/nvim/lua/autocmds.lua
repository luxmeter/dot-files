...
autocmd('BufWritePost', {
  ...
  callback = function(opts)
    ...
    local module = vim.fn.substitute(fp, '^.*/' .. app_name .. '/lua/', '', ''):gsub('/', '.')
...
-- Format Mongo Query {{{
cmd 'command! -range FormatMongoQuery <line1>,<line2>s/{"$binary": {"base64": \\(.\\{-}\\), "subtype": "03"}}/BinData(3, \\1)/ge | %!prettier --stdin --parser typescript'
-- }}}
