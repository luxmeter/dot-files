# Generated by Powerlevel10k configuration wizard on 2021-10-22 at 21:12 CEST.
...
# 24h time, vertical separators, round heads, round tails, 1 line, sparse, many icons,
...
() {
  ...
  function my_git_formatter() {
    ...
    # *42 if have stashes. (uncommented bc i don't care for stashes)
  ...
  function prompt_example() {
    ...
    if [[ "$context" != "" ]]; then
      p10k segment -f 208 -i $'\u2388' -t "${KUBECTL_CONTEXT:-}"
    fi
  }
