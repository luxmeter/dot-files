...
vim.opt.showmode = false -- disable as we show mode in status line
...
-- will be disabled for large files as it slows donw the search significantly such that it lags
